...
namespace DialogueSystem.Nodes
{
    ...
    public static class NodeDataCache {
        ...
        public static string GetTypeQualifiedName(Type type) {
            if(typeQualifiedNameCache == null) typeQualifiedNameCache = new Dictionary<Type, string>();
        ...
        private static void CachePorts(Type nodeType) {
            ...
            for (int i = 0; i < fieldInfo.Count; i++) {
                ...
                FormerlySerializedAsAttribute formerlySerializedAsAttribute = attribs.FirstOrDefault(x => x is FormerlySerializedAsAttribute) as FormerlySerializedAsAttribute;
                ...
                if (formerlySerializedAsAttribute != null) {
                    if (formerlySerializedAsCache == null) formerlySerializedAsCache = new Dictionary<Type, Dictionary<string, string>>();
