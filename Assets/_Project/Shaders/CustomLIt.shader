	...
	SubShader {
		...
		Pass {
			...
			half4 LitPassFragment(Varyings IN) : SV_Target {
                ...
                {                    
                    isNotAnotherDim = isNotAnotherDim && (distance(_GrenadesPositions[k].xz, IN.positionWS.xz) > _Dist);
                }
...
/*
				...
				IN.color = isNotAnotherDim * _MainColor + (1- isNotAnotherDim) *_SecondaryColor;
